...
const AuthPage = ({ initialMode = 'login' }) => {
  ...
  return (
    <div
      className="relative min-h-screen flex items-center justify-start px-4 sm:px-10 lg:px-16 py-10"
      style={{
    ...
    >
      ...
      <div className="relative w-full max-w-xl lg:w-[480px] bg-white/90 backdrop-blur-sm rounded-xl shadow-2xl p-6 sm:p-8">
